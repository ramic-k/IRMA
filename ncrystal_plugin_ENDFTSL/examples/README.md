...
`LTHR=3` (mixed elastic): a **coherent** Bragg comb, a small **incoherent**
...
The sawtooth is the coherent Bragg comb, sampled verbatim from the tape's
...
no incoherent). Each carries the **full per-atom Bragg comb**; the converter
...
The coherent Bragg comb (blue) is the sum of the Be and O fraction-weighted edge
...
**inelastic-only** — there is no Bragg comb, because the evaluation does not carry
