...
def test_auto_grid_is_the_endf_converged_grid_not_uniform():
    ...
    beta_ref = generate_beta_grid_for_iint(
        0.2, t_ref, iint=1, awr=awr, n_lower=50, n_phonon=300,
    ...
    beta_uncapped = generate_beta_grid(0.2, t_ref, n_lower=50, n_phonon=300,
                                       n_upper=80, beta_max_eV=5.0)
...
def test_auto_grid_honors_config_overrides():
    ...
    beta_ref = generate_beta_grid_for_iint(
        0.15, t_ref, iint=1, awr=awr, n_lower=50, n_phonon=120,
        n_upper=80, beta_max_eV=5.0)
