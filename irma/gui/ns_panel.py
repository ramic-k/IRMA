...
HELP = {
    ...
    "scatterers": (
        ...
        "                 (~ sigma_coh + sigma_inc). Normalizes the S(alpha,beta)\n"
        "                 table.  REQUIRED.\n"
        "  awr            atomic weight ratio A = M / m_n. Sets the recoil and\n"
        "                 Debye-Waller mass.  REQUIRED.\n"
        "  b_coh_fm       coherent scattering length [fm]; CAN BE NEGATIVE (H = -3.74).\n"
        "                 Drives the COHERENT elastic Bragg peaks. OPTIONAL: omit it\n"
        "                 and that element contributes no coherent-elastic line.\n"
        ...
        "MODE 0 (DOS) extras, appended as key=value tokens on the same line:\n"
        ...
        "  pos=x:y:z;.. fractional sites, ';'-separated (coherent-elastic peaks)\n"
